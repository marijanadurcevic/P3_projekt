    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(query.toLowerCase().equals("izlistaj sve")){
                    asyncTask.execute("https://oziz.ffos.hr/nastava20202021/mdurcevic_20/ontologija/search/");
                }else{
                    asyncTask.execute("https://oziz.ffos.hr/nastava20202021/mdurcevic_20/ontologija/search/"+query);
                }
